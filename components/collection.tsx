        ...
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-between">
            <p className="text-sm font-semibold">
              Green Bean Kopi Arabika dan Robusta Khas Desa Cinta
            </p>
            <p className="text-sm font-semibold">Rp80.000</p>
          </div>
          <Button asChild>
            <Link
              href={
    ...
    },
    {
      ...
      drawerFooter: (
        <div className="flex flex-col gap-3">
          <div className="flex items-center justify-between">
            <p className="text-sm font-semibold">
              Biji Kopi Cherrry Merah KHas Desa Cinta Dengan Karakter Body Tebal
              dan Keasaman Khas
            </p>
